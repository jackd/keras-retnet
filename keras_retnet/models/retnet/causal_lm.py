...
from .backbone import RetnetBackbone, backbone_presets


@keras.utils.register_keras_serializable("keras_retnet")
class RetnetCausalLM(GenerativeTask):  # pylint:disable=abstract-method
    """A thin wrapper around retnet backbone."""
    ...
    def _call_with_cache(
        ...
        *,
        ...
        """Forward pass of `retnetGPTCausalLM` with cache.
    ...
    def from_preset(
        ...
        **kwargs,
        ...
        if preprocessor is None:
            preprocessor = GPT2CausalLMPreprocessor.from_preset("gpt2_base_en")

        backbone = RetnetBackbone.from_preset(
            preset, load_weights=load_weights, **kwargs
        )
        return cls(backbone, preprocessor)
